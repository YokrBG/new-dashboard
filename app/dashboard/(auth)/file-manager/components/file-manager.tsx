...
import FileManagerPagination from "@/app/dashboard/(auth)/file-manager/components/pagination";
      ...
      <div className="border-border min-w-0 flex-1 space-y-4">
        ...
        <div className="flex justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-2xl font-bold tracking-tight">Upload your knowledge</h1>
